...
% Dynamically tailored for Nemetschek - Senior Software Engineer - CAD Platform
% Generated on 2025-09-22 21:14:05
% Job Match Score: 92.0%
% Missing Skills: 1
%------------------------
...
\begin{itemize}[leftmargin=*, itemsep=1pt]
    \item \textbf{Cloud Platforms:} azure, GCP, gcp, aws, AWS, Azure
    \item \textbf{Infrastructure & DevOps:} docker, ArgoCD, Docker, go, Go, Kubernetes
    \item \textbf{Programming & Development:} Python, python, C++, c++
\end{itemize}
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Infrastructure & Monitoring}
          {Streamlined deployments with \textbf{docker} and \textbf{kubernetes}; implemented Prometheus/Grafana for real-time monitoring}
...
\section{Projects}
  \resumeSubHeadingListStart
    \resumeSubItem{AI-Powered Network Traffic Classifier \textnormal{(C++, Python, TensorFlow, ONNX, eBPF, gRPC, Kubernetes)}}
      {Realtime packet/flow features via eBPF; ONNX model served over async \textbf{grpc} on \textbf{kubernetes} with rollout gua\textbf{rds} (shadow A/B, drift detection, canary). Qt6/Electron dashboard with rate/latency charts; CI for model eval (AUC/PR), onnxruntime CPU/GPU}
